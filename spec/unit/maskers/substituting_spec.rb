...
RSpec.describe AttrMasker::Maskers::Substituting do
  subject { described_class.new **options }

  let(:address) { "1 Pedder Street, Hong Kong" }

  shared_examples "AttrMasker::Maskers::Substituting examples" do
  ...
  context "with default options" do
    ...
    include_examples "AttrMasker::Maskers::Substituting examples"
  end
